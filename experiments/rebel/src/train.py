...
from lightning_data_modules import BaseLightningDataModule
from lightning_modules import BaseLightningModule
...
#         "additional_special_tokens": ['<obj>', '<subj>', '<triplet>'],
    ...
    # add special entity tokens to the tokenizer (extracts them before tokenizing as usual)
    ...
    if conf.entailement_filtering:
        wandb_run_name += f"-entail-filter"
