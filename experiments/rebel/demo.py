...
# load the dataset from the file rebel-short.py, which is a fancy 
# hugging face dataset generator thing why is this required ? These 
# datasets aren't that heavy, no ? Yes they are, multiple gigabytes, this makes sense. 
"""
dataset = load_dataset(
    'datasets/rebel-short.py', 
    data_files={
        'train': 'data/rebel/sample.jsonl', 
        'dev': 'data/rebel/sample.jsonl', 
        'test': 'data/rebel/sample.jsonl', 
        'relations': "data/relations_count.tsv"
    }, 
    split="validation"
)
"""
...
# feed the user slider chosen config to the model, e.g. tokenize and feed to the model
