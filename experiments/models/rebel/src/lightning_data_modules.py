...
class BaseLightningDataModule(LightningDataModule):
    ...
    def __init__(self, conf: DictConfig, tokenizer: AutoTokenizer, model: AutoModelForSeq2SeqLM):
        ...
        # relation files is a list of (relation, n_samples) pairs.
        ...
        """label in dataset of raw text"""
        self.summary_column = conf.target_column
        """label in dataset of the target to predict (triplets in all cases)"""
        self.max_target_length = conf.max_target_length
        """maximum amount of output tokens to generate"""
